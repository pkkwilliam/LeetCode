...
public class RepeatedStringMatch {
    public static void main(String[]args){
        String[][] input = {
                ...
                {"a","aa"},
                {"a","aba"},
                {"a","aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"}
        };

        for(String[] s : input)
            System.out.println(new Solution686().repeatedStringMatch(s[0],s[1]));
    }
}
class Solution686 {
